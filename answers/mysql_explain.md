...
| **possible_keys** | Indexes that MySQL *could* choose from to find rows. |
| **key** | The index that MySQL *actually* decided to use. |
...
- **Using where**: A `WHERE` clause is used to filter rows *after* fetching them from the storage engine.
...
---
*Source: [Habr - Читаем EXPLAIN на максималках](https://habr.com/ru/companies/citymobil/articles/545004/)*
