---
title: "Решения LeetCode - Страница 3"
sidebar_label: "Страница 3"
---

# Решения LeetCode - Страница 3

### 1672. Richest Customer Wealth
<span className="badge badge--success margin-bottom--md">Junior</span>

**Описание:** Решение задачи LeetCode "richest-customer-wealth" на PHP.
...
**Описание:** Решение задачи LeetCode "determine-if-string-halves-are-alike" на PHP.
...
**Описание:** Решение задачи LeetCode "find-the-highest-altitude" на PHP.
...
**Описание:** Решение задачи LeetCode "sum-of-unique-elements" на PHP.
...
**Описание:** Решение задачи LeetCode "substrings-of-size-three-with-distinct-characters" на PHP.
...
**Описание:** Решение задачи LeetCode "check-if-all-characters-have-equal-number-of-occurrences" на PHP.
...
**Описание:** Решение задачи LeetCode "sum-of-digits-of-string-after-convert" на PHP.
...
**Описание:** Решение задачи LeetCode "delete-characters-to-make-fancy-string" на PHP.
...
**Описание:** Решение задачи LeetCode "minimum-difference-between-highest-and-lowest-of-k-scores" на PHP.
...
**Описание:** Решение задачи LeetCode "reverse-prefix-of-word" на PHP.
...
**Описание:** Решение задачи LeetCode "check-whether-two-strings-are-almost-equivalent" на PHP.
...
**Описание:** Решение задачи LeetCode "most-frequent-number-following-key-in-an-array" на PHP.
...
**Описание:** Решение задачи LeetCode "find-the-difference-of-two-arrays" на PHP.
...
**Описание:** Решение задачи LeetCode "intersection-of-multiple-arrays" на PHP.
...
**Описание:** Решение задачи LeetCode "remove-digit-from-number-to-maximize-result" на PHP.
...
**Описание:** Решение задачи LeetCode "first-letter-to-appear-twice" на PHP.
...
**Описание:** Решение задачи LeetCode "minimum-recolors-to-get-k-consecutive-black-blocks" на PHP.
...
**Описание:** Решение задачи LeetCode "most-frequent-even-element" на PHP.
...
**Описание:** Решение задачи LeetCode "find-the-pivot-integer" на PHP.
...
**Описание:** <p>Given the <code>root</code> of a binary tree, return <em>the inorder traversal of its nodes&#39; values</em>.</p>
...
**Описание:** <p>Given a binary tree, find its minimum depth.</p>
...
**Описание:** <p>Given <code>head</code>, the head of a linked list, determine if the linked list has a cycle in it.</p>
...
**Описание:** <p>Given the <code>root</code> of a binary tree, return <em>the preorder traversal of its nodes&#39; values</em>.</p>
...
**Описание:** <p>Given the <code>root</code> of a&nbsp;binary tree, return <em>the postorder traversal of its nodes&#39; values</em>.</p>
...
**Описание:** <p>Given the <code>head</code> of a singly linked list, reverse the list, and return <em>the reversed list</em>.</p>
...
**Описание:** <p>Given the <code>root</code> of a <strong>complete</strong> binary tree, return the number of the nodes in the tree.</p>
...
**Описание:** <p>Given an integer <code>n</code>, return <em><code>true</code> if it is a power of two. Otherwise, return <code>false</code></em>.</p>
...
**Описание:** <p>Given the <code>root</code> of a binary search tree and a <code>target</code> value, return <em>the value in the BST that is closest to the</em> <code>target</code>. If there are multiple answers, print the smallest.</p>
...
**Описание:** <p>Given an integer <code>n</code>, return <em><code>true</code> if it is a power of three. Otherwise, return <code>false</code></em>.</p>
...
**Описание:** <p>Given a stream of integers and a window size, calculate the moving average of all integers in the sliding window.</p>
