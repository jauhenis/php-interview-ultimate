...
A **Materialized View** is a database object that contains the _actual results_ of a query, stored on disk like a physical table.
...
No. A view _is_ the regular query. However, a **Materialized View** is much faster because it avoids re-calculating the result set.
